...
Each finding MUST include a deterministic Location:
...
```json
{"trace_event":{"agent":"<project>-documentation-critic","operation":"critique","subtask":1,"iteration":1,"verdict":"REQUEST_CHANGES","blockers":1,"warnings":2,"input_tokens":980,"output_tokens":310,"duration_ms":9100}}
```
