<!--
TEMPLATE COPY NOTICE

- This file is shipped as part of `framework/templates/repo-files-templates/root/`.
- When you copy the template `root/` folder into your repo root, this becomes your project’s umbrella spec entrypoint.
- Canonical upstream (in ForgentFramework itself): `framework/00-multi-agent-development-spec.md`.
-->

# Multi-Agent Development Specification

> **Version:** 0.31.2 · **Updated:** 2026-03-05
