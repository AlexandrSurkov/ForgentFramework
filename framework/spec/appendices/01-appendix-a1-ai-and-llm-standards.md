...
| **Reflexion + explicit termination** — iteration reads `## Previous Attempts`; enforce `max_iterations: 3` and escalate to `NEEDS_HUMAN` if unresolved. | A1.2 (Reflexion, AutoGen) | [AGENTS.md](../../../AGENTS.md), [agent-patterns SKILL](../../../.agents/skills/agent-patterns/SKILL.md) |
