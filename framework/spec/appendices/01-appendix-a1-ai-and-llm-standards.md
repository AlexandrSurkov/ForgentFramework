...
| **Prefer open protocols over bespoke glue** — use MCP for tool access, A2A for agent-to-agent communication, and OTel GenAI conventions for traces/telemetry. | A1.1 | [templates/repo-files-templates/root/.vscode/mcp.json](../../templates/repo-files-templates/root/.vscode/mcp.json), [templates/repo-files-templates/root/.agents/traces/README.md](../../templates/repo-files-templates/root/.agents/traces/README.md) |
